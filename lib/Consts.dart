...
///Storage
const String USERS_COLLECTION = 'User Info';
const String USER_ABOUT_FIELD = 'about';
const String USER_DISPLAY_NAME = 'name';
const String USER_ID = 'uid';
const String USER_PHOTO_URI = 'profileImage';
...
const String TEXT_FIELD_HINT = 'Enter a message to send...';
...
const double MESSAGE_PADDING = 10.0;
const double MESSAGE_MARGIN = 10.0;
...
const FRIENDS_PHOTO_MARGIN = 10.0;
